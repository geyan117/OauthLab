...
import com.zero.sso.code.client.dto.oauth2.OAuth2AccessTokenRespDTO;
import com.zero.sso.code.client.dto.oauth2.OAuth2CheckTokenRespDTO;
...
public class OAuth2Client {
    ...
    private static final String CLIENT_ID = "zero-sso-code-demo";
    ...
    private static void addClientHeader(HttpHeaders headers) {
        ...
        client = Base64Encoder.encode(client.getBytes(StandardCharsets.UTF_8));
